...
# --- PatchMatch Stereo (Vanilla) のパラメータ ---
PATCHMATCH_STEREO_ITERATIONS = 10  # PatchMatch Stereoの反復回数
PATCHMATCH_STEREO_PATCH_SIZE = 7  # パッチサイズ (奇数)
PATCHMATCH_STEREO_MIN_DISP = 0    # 最小視差
PATCHMATCH_STEREO_MAX_DISP = 216  # 最大視差（StereoSGBMのnum_dispと合わせる）
PATCHMATCH_STEREO_DECAY_RATE = 0.9 # ランダム探索の減衰率
